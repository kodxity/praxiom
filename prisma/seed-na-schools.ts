...
const schools: S[] = [
  ...
  s('J. Percy Page High School',      'J. Percy Page',   'EPSB', 'epsb.ca'),
  s('Jasper Place High School',       'Jasper Place',    'EPSB', 'epsb.ca'),
  s('Lillian Osborne High School',    'Lillian Osborne', 'EPSB', 'epsb.ca'),
  s('M.E. LaZerte High School',       'M.E. LaZerte',    'EPSB', 'epsb.ca'),
  s('Old Scona Academic High School', 'Old Scona',       'EPSB', 'epsb.ca'),
  s('Ross Sheppard High School',      'Ross Sheppard',   'EPSB', 'epsb.ca'),
  s('Strathcona High School',         'Strathcona',      'EPSB', 'epsb.ca'),
  s('Victoria School of the Arts',    'Victoria',        'EPSB', 'epsb.ca'),
  s('W.P. Wagner High School',        'W.P. Wagner',     'EPSB', 'epsb.ca'),
  s('Windermere High School',         'Windermere',      'EPSB', 'epsb.ca'),
  s('Paul Kane High School',          'Paul Kane',       'EPSB', 'epsb.ca'),
