...
const schools = [
  ...
  { name: 'Eastglen High School',               shortName: 'Eastglen',         district: 'EPSB', emailDomain: 'share.epsb.ca' },
  { name: 'Harry Ainlay High School',           shortName: 'Harry Ainlay',     district: 'EPSB', emailDomain: 'share.epsb.ca' },
  { name: 'J. Percy Page High School',          shortName: 'J. Percy Page',    district: 'EPSB', emailDomain: 'share.epsb.ca' },
  { name: 'Jasper Place High School',           shortName: 'Jasper Place',     district: 'EPSB', emailDomain: 'share.epsb.ca' },
  { name: 'Lillian Osborne High School',        shortName: 'Lillian Osborne',  district: 'EPSB', emailDomain: 'share.epsb.ca' },
  { name: 'M.E. LaZerte High School',           shortName: 'M.E. LaZerte',     district: 'EPSB', emailDomain: 'share.epsb.ca' },
  { name: 'Old Scona Academic High School',     shortName: 'Old Scona',        district: 'EPSB', emailDomain: 'share.epsb.ca' },
  { name: 'Ross Sheppard High School',          shortName: 'Ross Sheppard',    district: 'EPSB', emailDomain: 'share.epsb.ca' },
  { name: 'Strathcona High School',             shortName: 'Strathcona',       district: 'EPSB', emailDomain: 'share.epsb.ca' },
  { name: 'Victoria School of the Arts',        shortName: 'Victoria',         district: 'EPSB', emailDomain: 'share.epsb.ca' },
  { name: 'W.P. Wagner High School',            shortName: 'W.P. Wagner',      district: 'EPSB', emailDomain: 'share.epsb.ca' },
  { name: 'Windermere High School',             shortName: 'Windermere',       district: 'EPSB', emailDomain: 'share.epsb.ca' },
  { name: 'Paul Kane High School',              shortName: 'Paul Kane',        district: 'EPSB', emailDomain: 'share.epsb.ca' },
  { name: 'Calder High School',                 shortName: 'Calder',           district: 'EPSB', emailDomain: 'share.epsb.ca' },
];
